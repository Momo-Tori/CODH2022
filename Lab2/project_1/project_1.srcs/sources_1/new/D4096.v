...
//输出部分
wire  [31:0]SegD;//六个数码管的十六进制形式
wire [7:0]Segout[7:0];//六个数码管的十六进制转化为Seg对应灯管亮起的信�?
...
sort_D4096 sort(CLK100MHZ,CPU_RESETN,DPsw,del,addr,data,chk,run,SegD,LED16_R,LED);
