...
#
# Generated by export_simulation on Tue Apr 12 10:31:49 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Data_Mem_DualPorts.sh' script.

./Data_Mem_DualPorts.sh -reset_run
...
./Data_Mem_DualPorts.sh -noclean_files

For more information on the script, please type './Data_Mem_DualPorts.sh -help'.
