...
add_files D:/CodeTry/CODExperiment/Lab4/coe/sort.coe
read_verilog -library xil_defaultlib {
  ...
  D:/CodeTry/CODExperiment/Lab4/cpuSort.v
}
...
synth_design -top CPUSort -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef CPUSort.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file CPUSort_utilization_synth.rpt -pb CPUSort_utilization_synth.pb"
