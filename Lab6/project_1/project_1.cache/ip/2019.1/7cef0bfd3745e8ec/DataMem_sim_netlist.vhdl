...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"C078C228A62C6DFA6B278302B9897AC8"
    )
        port map (
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"C7CA6BF34EF4D19637016EC97868E5CE"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"6D9092FF2AE79381F1DB487B9FE52374"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(2),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"3EAF7B2783F5D85FF52D2BE2FF9AEE78"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_4_4: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"7002763B6E406E84E12F4DFB48D66AF8"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(4),
...
ram_reg_0_127_5_5: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"4196BCA848F79751E488200D13BAD64C"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(5),
...
ram_reg_0_127_6_6: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"41AD904AA086AA495F37E20E0DB0E0C0"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(6),
